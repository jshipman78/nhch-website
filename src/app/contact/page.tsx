    ...
    <>
      ...
      <Section background="gradient" padding="lg">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-forest mb-6">Contact Us</h1>
      ...
      <Section background="white" padding="lg">
        <div className="grid lg:grid-cols-2 gap-12">
          {/* Contact Information */}
          <div>
            <h2 className="text-forest mb-6">Get in Touch</h2>
          ...
          <div>
            <div className="bg-muted rounded-xl p-6 lg:p-8 mb-8">
              <h2 className="text-forest mb-4">Schedule an Appointment</h2>
            ...
            <div className="bg-white rounded-xl border border-border p-6 lg:p-8">
              <h3 className="text-forest font-semibold mb-4">
                Request a Callback
              </h3>
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    id="preferred-time"
                    name="preferred-time"
                    className="w-full px-4 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-gold focus:border-transparent bg-white"
                  >
              ...
              <p className="text-warmgray text-xs mt-4">
                By submitting this form, you agree to be contacted by NHCH.
                This form is for scheduling purposes only. Please do not include
        ...
        <div className="rounded-xl overflow-hidden shadow-lg h-96 bg-warmgray/20 flex items-center justify-center">
          <div className="text-center p-8">
            ...
            <a
              ...
              className="text-forest hover:text-gold font-medium transition-colors"
            >
      ...
      <Section background="white" padding="md">
        <div className="max-w-2xl mx-auto">
          <h3 className="text-forest font-semibold mb-4 text-center">
            Holiday Closures
          </h3>
